    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center p-4 relative">
            ...
            <div className="max-w-sm w-full bg-white p-8 rounded-2xl shadow-xl">
                ...
                <p className="text-center text-gray-500 mb-8">Bem-vindo ao Painel de Gerenciamento</p>
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            required
                            className="mt-1 w-full p-3 border rounded-lg bg-gray-50 focus:ring-2 focus:ring-orange-400 focus:outline-none"
                    ...
                    <button
                        ...
                        className="w-full bg-orange-600 text-white font-bold py-3 rounded-lg hover:bg-orange-700 transition-colors disabled:bg-orange-300"
                    >
                        {isLoggingIn ? <Spinner message="Entrando..." /> : 'Entrar'}
                    </button>
                </form>
                ...
                {error && <p className="text-red-500 text-center mt-4 text-sm font-semibold">{error}</p>}
                 <p className="text-center text-gray-500 mt-6 text-xs">
                    Use as credenciais fornecidas para acessar o painel de administrador ou comerciante.
                </p>
            </div>
        </div>
    );
