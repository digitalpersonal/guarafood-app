...
-- Causa Raiz: As políticas de segurança (RLS) consultavam a tabela 'profiles'
-- para verificar a role do usuário. Isso acionava a RLS da própria tabela
-- 'profiles', criando um loop infinito.
--
-- Solução: Criar funções com 'SECURITY DEFINER'. Essas funções rodam com
-- privilégios elevados, ignorando a RLS para as tabelas que consultam
-- internamente. Isso quebra o ciclo de recursão de forma segura e é a
-- prática recomendada pelo Supabase para este cenário.
-- ==============================================================================
