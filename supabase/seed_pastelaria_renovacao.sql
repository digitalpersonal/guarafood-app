...
-- Pastéis
INSERT INTO public.menu_items (restaurant_id, category_id, name, description, price, image_url) VALUES
    ((SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação'), (SELECT id FROM menu_categories WHERE name = 'Pastéis' AND restaurant_id = (SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação')), 'CARNE', '', 12.00, 'https://images.pexels.com/photos/10884615/pexels-photo-10884615.jpeg?auto=compress&cs=tinysrgb&w=400'),
    ((SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação'), (SELECT id FROM menu_categories WHERE name = 'Pastéis' AND restaurant_id = (SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação')), 'PIZZA', '', 12.00, 'https://images.pexels.com/photos/18449171/pexels-photo-18449171/free-photo-of-brazilian-pastel-pastries-with-cheese.jpeg?auto=compress&cs=tinysrgb&w=400'),
    ((SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação'), (SELECT id FROM menu_categories WHERE name = 'Pastéis' AND restaurant_id = (SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação')), 'FRANGO CATUPIRY', '', 12.00, 'https://images.pexels.com/photos/7454378/pexels-photo-7454378.jpeg?auto=compress&cs=tinysrgb&w=400'),
    ((SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação'), (SELECT id FROM menu_categories WHERE name = 'Pastéis' AND restaurant_id = (SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação')), 'QUEIJO', '', 12.00, 'https://images.pexels.com/photos/18449171/pexels-photo-18449171/free-photo-of-brazilian-pastel-pastries-with-cheese.jpeg?auto=compress&cs=tinysrgb&w=400'),
    ...
    ((SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação'), (SELECT id FROM menu_categories WHERE name = 'Pastéis' AND restaurant_id = (SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação')), 'FRANGO MINEIRO', '', 13.00, 'https://images.pexels.com/photos/7454378/pexels-photo-7454378.jpeg?auto=compress&cs=tinysrgb&w=400'),
    ((SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação'), (SELECT id FROM menu_categories WHERE name = 'Pastéis' AND restaurant_id = (SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação')), 'CARNE COM QUEIJO', '', 14.00, 'https://images.pexels.com/photos/10884615/pexels-photo-10884615.jpeg?auto=compress&cs=tinysrgb&w=400'),
    ((SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação'), (SELECT id FROM menu_categories WHERE name = 'Pastéis' AND restaurant_id = (SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação')), '4 QUEIJOS', '', 14.00, 'https://images.pexels.com/photos/18449171/pexels-photo-18449171/free-photo-of-brazilian-pastel-pastries-with-cheese.jpeg?auto=compress&cs=tinysrgb&w=400'),
    ((SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação'), (SELECT id FROM menu_categories WHERE name = 'Pastéis' AND restaurant_id = (SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação')), '4 QUEIJOS COM BACON', '', 15.00, 'https://images.pexels.com/photos/18449171/pexels-photo-18449171/free-photo-of-brazilian-pastel-pastries-with-cheese.jpeg?auto=compress&cs=tinysrgb&w=400'),
    ((SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação'), (SELECT id FROM menu_categories WHERE name = 'Pastéis' AND restaurant_id = (SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação')), 'FRANGO COM QUEIJO', '', 14.00, 'https://images.pexels.com/photos/7454378/pexels-photo-7454378.jpeg?auto=compress&cs=tinysrgb&w=400'),
...
-- Pastéis Doces
INSERT INTO public.menu_items (restaurant_id, category_id, name, description, price, image_url) VALUES
    ((SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação'), (SELECT id FROM menu_categories WHERE name = 'Pastéis Doces' AND restaurant_id = (SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação')), 'CHOCOLATE AO LEITE', '', 12.00, 'https://images.pexels.com/photos/18449168/pexels-photo-18449168/free-photo-of-brazilian-pastel-pastries-with-chocolate.jpeg?auto=compress&cs=tinysrgb&w=400'),
    ((SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação'), (SELECT id FROM menu_categories WHERE name = 'Pastéis Doces' AND restaurant_id = (SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação')), 'CHOCOLATE MISTO', '', 12.00, 'https://images.pexels.com/photos/14101374/pexels-photo-14101374.jpeg?auto=compress&cs=tinysrgb&w=400'),
    ((SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação'), (SELECT id FROM menu_categories WHERE name = 'Pastéis Doces' AND restaurant_id = (SELECT id FROM restaurants WHERE name = 'Pastelaria Renovação')), 'CHOCOLATE BRANCO', '', 12.00, 'https://images.pexels.com/photos/1070850/pexels-photo-1070850.jpeg?auto=compress&cs=tinysrgb&w=400');
