import React, { createContext, useState, useContext, useCallback, useRef, ReactNode, useEffect, useMemo } from 'react';
    ...
    return (
        <img
            ...
            style={{
                ...
                opacity: '1',
                left: `${item.startRect.left}px`,
                top: `${item.startRect.top}px`,
                width: `${item.startRect.width}px`,
                height: `${item.startRect.height}px`,
            }}
        />
    );
};
...
export function AnimationProvider({ children }: { children: ReactNode }) {
    ...
    const value = useMemo(() => ({ addFlyingItem, setCartElement }), [addFlyingItem, setCartElement]);
