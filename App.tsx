...
const CustomerView: React.FC<{ selectedRestaurant: Restaurant | null; onSelectRestaurant: (r: Restaurant | null) => void }> = ({ selectedRestaurant, onSelectRestaurant }) => {
    ...
    return (
        <main className="pb-16 bg-white min-h-screen">
            ...
            <div className="px-4 py-2 flex gap-2 overflow-x-auto no-scrollbar border-b border-gray-100 pb-4 sticky top-[64px] bg-white z-10 shadow-sm">
                <button 
...
const AppContent: React.FC = () => {
    ...
    return (
        <div className="container mx-auto max-w-7xl bg-white min-h-screen flex flex-col shadow-xl overflow-x-hidden pt-[64px]">
            <VersionChecker />
            <HeaderGlobal 
